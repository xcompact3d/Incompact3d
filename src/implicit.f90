...
subroutine scalarimp(ux1,uy1,uz1,phi1,dphi1,is)
  ...
  call derxxS (tg1,phi1,di1,sx,sfxt,ssxt,swxt,xsize(1),xsize(2),xsize(3),0) ! npaire=0
  ...
  call derzzS (ta3,phi3,di3,sz,sfzt,sszt,swzt,zsize(1),zsize(2),zsize(3),0) ! npaire=0
...
subroutine multmatrix7T(td2,ta2,ux2)
  ...
  if (.true.) then
     ...
     if (ncly1.eq.0) then
        ...
        call deryyS(td2,ux2,di2,sy,sfyt,ssyt,swyt,ysize(1),ysize(2),ysize(3),0)

     elseif (ncly1.eq.1) then

        call deryyS(td2,ux2,di2,sy,sfyt,ssyt,swyt,ysize(1),ysize(2),ysize(3),0) ! npaire=0
