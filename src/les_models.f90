...
contains
  ...
  subroutine sgs_scalar_nonconservative(sgsphi1,nut1,phi1,is)
    ...
    call ibm_deryS (tb2, phi2, di2, sy, ffypS, fsypS, fwypS, ppy, ysize(1), ysize(2), ysize(3), 1, zero)
    iimplicit = - iimplicit
    call ibm_deryyS(tc2, phi2, di2, sy, sfypS, ssypS, swypS, ysize(1), ysize(2), ysize(3), 1, zero)
    iimplicit = - iimplicit
    if (istret.ne.0) then
       do k = 1, ysize(3)
       do j = 1, ysize(2)
    ...
    call ibm_derzS (tb3, phi3, di3, sz, ffzpS, fszpS, fwzpS, zsize(1), zsize(2), zsize(3), 1, zero)
    call ibm_derzzS(tc3, phi3, di3, sz, sfzpS, sszpS, swzpS, zsize(1), zsize(2), zsize(3), 1, zero)
