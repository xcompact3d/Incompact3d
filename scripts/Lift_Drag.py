...
#itime, drag, lift = loadtxt('aerof1',unpack=True, usecols=[0,2,3])
itime2, drag2,lift2 = loadtxt('aerof1-0090000',unpack=True, usecols=[0,2,3])
...
ax2.plot(itime,drag,ls='-',color='blue',linewidth=2.0, label='Stationary ')
