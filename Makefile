...
SRCDECOMP = $(DECOMPDIR)/factor.f90 $(DECOMPDIR)/decomp_2d_constants.f90 $(DECOMPDIR)/decomp_2d_mpi.f90 $(DECOMPDIR)/decomp_2d.f90 $(DECOMPDIR)/log.f90 $(DECOMPDIR)/glassman.f90 $(DECOMPDIR)/fft_$(FFT).f90 $(DECOMPDIR)/fft_log.f90 $(DECOMPDIR)/io.f90
